...
randnum=[r.randint(-1000,1000) for b in range(999)]
meannum=sum(randnum)/len(randnum)
mediannum=randnum[len(sorted(randnum))//2]
print('The minimum value of the list is ',sorted(randnum)[0])
print('the maximum value of the list is ',sorted(randnum)[998])
print('The mean of the list is ',meannum)
print('The median of the list is ',mediannum)
#Problem 2: (10 points)
#Your code goes below 
q=45
num1=[r.randint(0,500) for i in range(q)]
num2=[r.randint(0,500) for i in range(q)]
manhattan=sum([abs(num1[i]-num2[i]) for i in range(q)])
print('The Manhattan distance between two random number lists with range ',q,' is ',manhattan)
import math as m
euclidean=m.sqrt(sum([(num1[i]-num2[i])**2 for i in range(q)]))
print('The euclidean distance between two random number lists with range',q,' is',(euclidean))
#Problem 3: (6 points)
...
#       decreament j by 1
#   assign key to A[j+1]
A = [r.randint(0,1000) for i in range(50)]
#Your code goes below
